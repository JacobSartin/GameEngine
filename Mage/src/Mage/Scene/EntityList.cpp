...
EntityList::Iterator::Iterator(pointer ptr) : ptr(ptr) {}
...
EntityList::ConstIterator::ConstIterator(pointer ptr) : ptr(ptr) {}

EntityList::ConstIterator::reference
...
bool operator==(const EntityList::ConstIterator &a,
                const EntityList::ConstIterator &b) {
  return a.ptr == b.ptr;
}
...
Entity *EntityList::at(size_t pos) { return list[pos]; }

const Entity *EntityList::at(size_t pos) const { return list[pos]; }

Entity *EntityList::operator[](size_t pos) { return list[pos]; }

const Entity *EntityList::operator[](size_t pos) const { return list[pos]; }

Entity *EntityList::front() { return list[0]; }

const Entity *EntityList::front() const { return list[0]; }

Entity *EntityList::back() { return list[count - 1]; }

const Entity *EntityList::back() const { return list[count - 1]; }

Entity **EntityList::data() { return list; }

const Entity **EntityList::data() const {
  return const_cast<const Entity **>(list);
}

bool EntityList::empty() const { return count <= 0; }

size_t EntityList::size() const { return count; }
